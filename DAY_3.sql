...
SELECT MAX(age) FROM (SELECT * FROM EMPLOYEE WHERE name LIKE '%a%') AS temp;
...
SELECT * FROM EMPLOYEE;
-- CREATE VIEW
CREATE VIEW CUSTOME_VIEW AS SELECT name, age, emailID FROM EMPLOYEE;
SELECT * FROM CUSTOME_VIEW;
ALTER VIEW CUSTOME_VIEW AS SELECT name, age, emailID, phoneNo FROM EMPLOYEE;
